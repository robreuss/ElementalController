...
#ifndef ELEMENTALCONTROLLER_SWIFT_H
#define ELEMENTALCONTROLLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ElementalController",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC19ElementalController7Browser")
...
@interface Browser (SWIFT_EXTENSION(ElementalController)) <NSNetServiceBrowserDelegate>
